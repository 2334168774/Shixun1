                ...
                <div className="homediv3">
                    ...
                    <div style={{height:600,width:"100%",float:"left"}}>
                        <div className="homedivlisttop">
                            <p style={{float:"left",marginLeft:"5%",marginTop:"4%"}}>标题</p>
                            <p style={{float:"left",marginLeft:"21%",marginTop:"4%"}}>内容</p>
                            <p style={{float:"left",marginLeft:"21%",marginTop:"4%"}}>姓名</p>
                            <p style={{float:"left",marginLeft:"10%",marginTop:"4%"}}>点击量</p>
                            <p style={{float:"left",marginLeft:"8%",marginTop:"4%"}}>时间</p>
                            <p style={{float:"left",marginLeft:"8%",marginTop:"4%"}}>操作</p>
                        </div>
                        <div className="homedivlist">
                            <p style={{float:"left",marginLeft:"5%",marginTop:"2%"}}>这是标题</p>
                            <p style={{float:"left",marginLeft:"13%",marginTop:"2%"}}>内容内容内容内容内容……</p>
                            <p style={{float:"left",marginLeft:"12%",marginTop:"2%"}}>薛干事</p>
                            <p style={{float:"left",marginLeft:"11%",marginTop:"2%"}}>0</p>
                            <p style={{float:"left",marginLeft:"8%",marginTop:"2%"}}>2019/12/4</p>
                            <p style={{float:"left",marginLeft:"6%",marginTop:"2%",color:"#456ab5"}}>操作</p>
                        </div>
                        <div className="homedivlist">
                            <p style={{float:"left",marginLeft:"5%",marginTop:"2%"}}>这是标题</p>
                            <p style={{float:"left",marginLeft:"13%",marginTop:"2%"}}>内容内容内容内容内容……</p>
